    ...
    local function createBtn(text, panel, dock)
        ...
        btn.Paint = function(pnl, w, h)
            if text == "Class/Perks" then
                ...
                local _sub = HORDE.subclasses and HORDE.subclasses[MySelf:Horde_GetCurrentSubclass()]
                if not _sub then return end
                local class_mat = Material(_sub.Icon, "mips smooth")
