...
function scoreboard:show()
    ...
    function title:Paint(w, h)
        ...
        local _diff_name = HORDE.difficulty_text and HORDE.difficulty_text[HORDE.difficulty] or ""
        local _diff_label = (_diff_name ~= "") and translate.Get("Game_Difficulty_" .. _diff_name) or ""
        draw_SimpleText("Horde - " .. map_name .. " - " .. _diff_label, "Title", 10, 12, HORDE.color_crimson_dim, TEXT_ALIGN_LEFT)
