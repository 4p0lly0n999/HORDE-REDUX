...
for i, filename in pairs(file.Find(GM.FolderName.."/gamemode/modules/languages/*.lua", "LUA")) do
	LANGUAGE = {}
	local lang_full = GM.FolderName.."/gamemode/modules/languages/"..filename
	AddCSLuaFile(lang_full)
	include(lang_full)
