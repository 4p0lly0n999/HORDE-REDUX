...
HORDE.hundred_mode = false           -- set to true by HUNDRED difficulty
HORDE.hundred_scale_per_wave = 0     -- HP/DMG multiplier per wave after wave 10
HORDE.endless_health_multiplier = 1  -- reused by HUNDRED scaling
HORDE.endless_damage_multiplier = 1  -- reused by HUNDRED scaling
HORDE.endless = 0                    -- kept for compatibility, always 0
...
HORDE.difficulty_text = {}  -- filled by sv_difficulty.lua (server) / Horde_SyncDifficultyText (client)
