function GM:RegisterCustomConfig(name)
    local classfiles, classdirectories = file.Find(self.FolderName .. "/gamemode/core_systems/custom/*", "LUA")
    ...
    for i, filename in ipairs(classfiles) do
        if string.sub(filename, -4) == ".lua" then
            ...
            CONFIG = {}
            AddCSLuaFile(self.FolderName.."/gamemode/core_systems/custom/"..filename)
            include(self.FolderName.."/gamemode/core_systems/custom/"..filename)
