...
if SERVER then
    ...
    -- Откладываем инициализацию предметов до полной загрузки всех модулей
    -- (GetDefaultItemsData нужны HORDE.gadgets которые грузятся в PHASE 2)
    hook.Add("Horde_AllModulesLoaded", "Horde_InitItems", function()
